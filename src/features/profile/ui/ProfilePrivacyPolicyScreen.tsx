...
const VERSIONS: PolicyVersion[] = [
  {
    ...
    label: '버전 1 (25.01.01)',
    content:
      '버전1 상세 개인정보 처리 방침 버전1 상세 개인정보 처리 방침 버전1 상세 개인정보 처리 방침 버전1 상세 개인정보 처리 방침 버전1 상세 개인정보 처리 방침 버전1 상세 개인정보 처리 방침 버전1 상세 개인정보 처리 방침 버전1 상세 개인정보 처리 방침 ',
  },
  {
    id: 2,
    label: '버전 2 (25.06.01)',
    content:
      '버전2 상세 개인정보 처리 방침 버전2 상세 개인정보 처리 방침 버전2 상세 개인정보 처리 방침 버전2 상세 개인정보 처리 방침 버전2 상세 개인정보 처리 방침 버전2 상세 개인정보 처리 방침 버전2 상세 개인정보 처리 방침 버전2 상세 개인정보 처리 방침 ',
  },
]
...
export function ProfilePrivacyPolicyScreen() {
  ...
  // versionRow의 onLayout y+height = screen 기준 드롭다운 top 위치
    ...
    <View style={styles.screen}>
      ...
      <View style={[styles.topBarOuter, { paddingTop: insets.top + 8 }]}>
        <View style={styles.topBarInner}>
          ...
          <Text style={styles.topBarTitle}>개인정보 처리 방침</Text>
        </View>
      </View>

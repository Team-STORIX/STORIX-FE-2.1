...
export const Typography = {
  ...
  // 2.0 .date-text
  dateText:          { fontSize: 16, fontWeight: FontWeight.bold,      lineHeight: 22, color: Gray[500] } as TextStyle,
} as const
...
function makeShadow(elevation: number, opacity: number, radius: number, offsetY: number): ViewStyle {
...
export const Shadow = {
  ...
  lg:   makeShadow(6, 0.10, 12, 4), // tailwind shadow-md
} as const

...
export const Typography = {
  heading1:        { fontFamily: FontFamily.bold,      fontSize: 24, lineHeight: 34 } as TextStyle,
  heading2:        { fontFamily: FontFamily.bold,      fontSize: 20, lineHeight: 28 } as TextStyle,
  heading3:        { fontFamily: FontFamily.semibold,  fontSize: 18, lineHeight: 26 } as TextStyle,
  heading4:        { fontFamily: FontFamily.semibold,  fontSize: 16, lineHeight: 22 } as TextStyle,

  body1Medium:     { fontFamily: FontFamily.medium,    fontSize: 16, lineHeight: 22 } as TextStyle,
  body1Semibold:   { fontFamily: FontFamily.semibold,  fontSize: 16, lineHeight: 22 } as TextStyle,
  body1Bold:       { fontFamily: FontFamily.bold,      fontSize: 16, lineHeight: 22 } as TextStyle,

  body2Medium:     { fontFamily: FontFamily.medium,    fontSize: 14, lineHeight: 20 } as TextStyle,
  body2Bold:       { fontFamily: FontFamily.bold,      fontSize: 14, lineHeight: 20 } as TextStyle,

  caption1Medium:   { fontFamily: FontFamily.medium,   fontSize: 12, lineHeight: 17 } as TextStyle,
  caption1Semibold: { fontFamily: FontFamily.semibold, fontSize: 12, lineHeight: 17 } as TextStyle,
  caption1Extrabold:{ fontFamily: FontFamily.extrabold,fontSize: 12, lineHeight: 17 } as TextStyle,
  ...
  dateText: { fontFamily: FontFamily.bold, fontSize: 16, lineHeight: 22, color: Gray[500] } as TextStyle,
} as const;
